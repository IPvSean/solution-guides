    ...
    <section id="solution-guides" class="cards-guide-section">
      ...
      <div id="aiops-solutions" class="cards-track-section">
        ...
        <div id="aiops-use-cases" class="cards-track-section cards-track-section--use-cases">
          ...
          <p class="cards-track-section__intro">Pattern-level adoption paths from EDA to orchestration. Each use case has its own page; partner cards below cover integration depth.</p>
          ...
          <details class="use-case-strip-details" open>
