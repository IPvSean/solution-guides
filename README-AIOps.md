...
- <img src="https://cdn.jsdelivr.net/gh/twitter/twemoji@14.0.2/assets/72x72/1f4cb.png" width="20" style="vertical-align:text-bottom;"> **Planning ticket enrichment adoption?** See [Ticket Enrichment Automation: From EDA to AI-Driven Orchestration](README-AIOps-Ticket-Enrichment.md) for stage-by-stage guidance on when EDA and AAP are enough, when to add LLM enrichment, and when Automation Orchestrator becomes the right next step.
